...
class GraphData(object):
    ...
    def __getitem__(self, idx):
        ...
        return g.A, g.new_feas.float(), g.label,g.ori_A, g.ori_feas.float()
    ...
    def __next__(self):
        ...
        gs, hs, labels, ori_gs, ori_hs = map(list, zip(*data))
        return len(gs), gs, hs, torch.LongTensor(labels),ori_gs, ori_hs
